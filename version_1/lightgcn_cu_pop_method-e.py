...
# Method E: popularity-aware negative sampling
# =========================
def sample_neg_item_popmix(indptr, indices, user: int, num_items: int, rng: np.random.Generator,
                           pop_prob: np.ndarray, mix_pop: float, max_tries: int):
    """
